...
class Style():
    def __init__(self, name, library: Library):
        ...
        self.header_top_margin = header_margin['Top'] * mm
        self.header_left_margin = header_margin['Left'] * mm
        self.header_right_margin = header_margin['Right'] * mm
        self.header_bottom_margin = header_margin['Bottom'] * mm
        header_height = header['Height'] * mm
        header_width = card_width - self.header_left_margin - self.header_right_margin
        ...
        self.header_box = Box(self.header_left_margin, card_height - header_height - self.header_top_margin, header_width, header_height)
        ...
        self.details_box = Box(border_width + self.details_padding.left, border_width + self.details_padding.bottom, card_width - self.details_padding.left - self.details_padding.right - border_width * 2, card_height - header_height - self.header_top_margin - border_width - self.details_padding.top - self.details_padding.bottom)
